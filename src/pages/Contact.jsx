    ...
    <div className="  flex flex-col gap-8 py-8">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-7" >
        ...
        <div className="flex flex-col gap-5  py-5">
          ...
          <button className="mt-1 border border-gray-800 py-3 self-center md:self-start px-6 hover:bg-primary hover:text-white hover:border-gray-100 transition-all duration-500 cursor-pointer" >Explore Jobs</button>
        </div>
      </div>
    </div>
  );
